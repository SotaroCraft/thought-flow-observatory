...
| [`m5-sensor-decision.md`](m5-sensor-decision.md) | OpenAlex Phase 1 source decision record | OpenAlex Phase 1 recorded; RF boundary updated by narrow close-out |
| [`m5-openalex-vocabulary-review.md`](m5-openalex-vocabulary-review.md) | §4 vocabulary review outcome (Human-delegated AI-assisted) | Completed; vocabulary unchanged |
| [`m5-narrow-closeout.md`](m5-narrow-closeout.md) | M5 narrow close-out: RF recommendation + PoC scope | Cursor recommendation; Human / Codex final |
